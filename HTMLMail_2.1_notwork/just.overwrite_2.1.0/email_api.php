 ...
 * @return integer|null
 */
function email_store( $p_message_id, $p_recipient, $p_subject, $p_message, array $p_headers = null, $p_params = null, $p_force = false ) {
	global $g_email_shutdown_processing;
...
function email_send( EmailData $p_email_data ) {
	...
	$t_mail->IsHTML ( isset( $t_email_data->metadata['Content-Type'] ) && stripos( $t_email_data->metadata['Content-Type'], "text/html" ) !== false ) ;              # set email format to plain text
